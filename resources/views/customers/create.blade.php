...
@section('content')
    ...
    <x-breadcrumb :home-route="['name' => 'Home', 'url' => route('dashboard')]" :parent-route="['name' => 'customers', 'url' => route('customers.index')]" :current-route="['name' => 'Create', 'url' => null]" />
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <h3>{{ __('labels.customer_title') }}</h3>
                    </div>
                    <form action="{{ route('customers.store') }}" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="name" name="name" placeholder="{{ __('labels.customer_name_placeholder') }}"
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="email" class="form-control @error('stock') is-invalid @enderror"
                                    id="email" name="email"
                                    placeholder="{{ __('labels.customer_email_placeholder') }}" value="{{ old('email') }}"
                                    required>
                                @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="number" class="form-control @error('phone') is-invalid @enderror"
                                    id="phone" name="phone"
                                    placeholder="{{ __('labels.customer_phone_placeholder') }}"
                            ...
                            <div class="form-group col-lg-4">
                                <label for="address"
                                    class="font-weight-medium">{{ __('labels.customer_address') }}</label>
                                <input type="text" class="form-control @error('address') is-invalid @enderror"
                                    id="address" name="address"
                                    placeholder="{{ __('labels.customer_address_placeholder') }}"
                        ...
                        <button type="submit" title="{{ __('titles.add_customer') }}"
