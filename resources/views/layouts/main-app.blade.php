                    ...
                    <ul class="nav sidebar-inner" id="sidebar-menu">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="collapse" id="status" data-parent="#sidebar-menu">
                                <div class="sub-menu">
                                    <li>
                                        <a class="sidenav-item-link" href="{{ route('statuses.index') }}">
                                            <span class="nav-text">List</span>

                                        </a>
                                    </li>
                                    <li>
                                        <a class="sidenav-item-link" href="{{ route('statuses.create') }}">
                                            <span class="nav-text">Create</span>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="collapse" id="purchase" data-parent="#sidebar-menu">
                                <div class="sub-menu">
                                    <li>
                                        <a class="sidenav-item-link" href="{{ route('purchases.index') }}">
                                            <span class="nav-text">List</span>

                                        </a>
                                    </li>
                                    <li>
                                        <a class="sidenav-item-link" href="{{ route('purchases.create') }}">
                                            <span class="nav-text">Create</span>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="collapse" id="saleItem" data-parent="#sidebar-menu">
                                <div class="sub-menu">
                                    <li>
                                        <a class="sidenav-item-link" href="{{ route('saleItems.index') }}">
                                            <span class="nav-text">List</span>

                                        </a>
                                    </li>
                                    <li>
                                        <a class="sidenav-item-link" href="{{ route('saleItems.create') }}">
                                            <span class="nav-text">Create</span>
