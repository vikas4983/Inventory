...
@section('content')
    <x-breadcrumb :home-route="['name' => 'Home', 'url' => route('dashboard')]" :parent-route="['name' => 'sales', 'url' => route('sales.index')]" :current-route="['name' => 'Create', 'url' => null]" />
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow">
                <div class="card-body">
                    <div class="text-center">
                        <h3>{{ __('labels.sale_title') }}</h3>
                    </div>
                    ...
                    <form action="{{ route('sales.store') }}" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <label for="user_id"
                                    class="font-weight-medium">{{ __('labels.sale_customer_id') }}</label>
                                <select name="customer_id" id="user_id" value="{{ old('user_id') }}"
                            ...
                            <div class="form-group col-lg-4">
                                <label for="sale_date"
                                    class="font-weight-medium">{{ __('labels.sale_date') }}</label>
                            ...
                            <div class="form-group col-lg-4">
                                <label for="total"
                                    class="font-weight-medium">{{ __('labels.sale_total') }}</label>
                        ...
                        <button type="submit" title="{{ __('titles.add_sale') }}"
        ...
        <tbody>
            @forelse ($products as $index => $product)
                <tr>
                    ...
                    <td>{{ Str::limit($product->cost_total, 15) ?? '' }}</td>
                    <td>{{ Str::limit($product->selling_total, 15) ?? '' }}</td>
