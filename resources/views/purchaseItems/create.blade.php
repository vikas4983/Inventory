...
@section('content')
    <x-breadcrumb :home-route="['name' => 'Home', 'url' => route('dashboard')]" :parent-route="['name' => 'purchaseItems', 'url' => route('purchaseItems.index')]" :current-route="['name' => 'Create', 'url' => null]" />
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow">
                <div class="card-body">
                    <div class="text-center">
                        <h3>{{ __('labels.purchase_item_title') }}</h3>
                    </div>
                    ...
                    <form action="{{ route('purchaseItems.store') }}" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <label for="purchase_id"
                                    class="font-weight-medium">{{ __('labels.purchase_item_purchase_id') }}</label>
                            ...
                            <div class="form-group col-lg-4">
                                <label for="product_id"
                                    class="font-weight-medium">{{ __('labels.purchase_item_product_id') }}</label>
                            ...
                            <div class="form-group col-lg-4">
                                <label for="quantity"
                                    class="font-weight-medium">{{ __('labels.purchase_item_quantity') }}</label>
                            ...
                            <div class="form-group col-lg-4">
                                <label for="price"
                                    class="font-weight-medium">{{ __('labels.purchase_item_price') }}</label>
                        ...
                        <button type="submit" title="{{ __('titles.add_purchase_item') }}"
